...
#pragma warning disable CS0162 // unreachable code (intentional — see note above)
            ...
            panelSource.Items.Add(new RibbonButton
            {
                ...
                ToolTip        = "Metraj (BoQ)" + System.Environment.NewLine +
                                 "Metraj penceresini açar. Pencere içinden sırasıyla:\n" +
            ...
            panelSource.Items.Add(new RibbonButton
            {
                ...
                ToolTip        = "Bacaya Katalog Ata" + System.Environment.NewLine +
                                 "Seçilen baca entity'lerine (AG_GUID) bir kazı kataloğu\n" +
            ...
            panelSource.Items.Add(new RibbonButton
            {
                ...
                ToolTip        = "Baca Keşif Tablosu" + System.Environment.NewLine +
                                 "UT_BOQ_HESAPLA ile kaydedilmiş BoQ verisinden,\n" +
            ...
            panelSource.Items.Add(new RibbonButton
            {
                ...
                ToolTip        = "Metraj Keşif Tablosu" + System.Environment.NewLine +
                                 "UT_BOQ_HESAPLA ile kaydedilmiş BoQ verisinden,\n" +
            ...
            panelSource.Items.Add(new RibbonButton
            {
                ...
                ToolTip        = "Akıllı Montaj" + System.Environment.NewLine +
                                 "Katalogları ve kuralları tek pencerede toplayan çok sekmeli sistem:\n" +
            ...
            panelSource.Items.Add(new RibbonButton
            {
                ...
                ToolTip        = "Proje Ayarları" + System.Environment.NewLine +
                                 "DWG'ye özgü ayarlar:\n" +
            ...
            panelSource.Items.Add(new RibbonButton
            {
                ...
                ToolTip        = "Ağ Seçim Paneli" + System.Environment.NewLine +
                                 "Çizimdeki ağları listeler; her ağ için Aktif ve\n" +
...
#pragma warning restore CS0162
    ...
    internal sealed class RibbonCommandRelay : System.Windows.Input.ICommand
    {
        ...
        {
            var dm = Bricscad.ApplicationServices.Application.DocumentManager;
